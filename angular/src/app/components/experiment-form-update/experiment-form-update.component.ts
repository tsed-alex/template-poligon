...
import { AbstractControl, FormBuilder, FormGroup, NG_VALIDATORS, ValidationErrors, ValidatorFn } from '@angular/forms';
import { of } from 'rxjs';
...
import { validateDuplicateMapField } from '../../shared/utils/validator'

// export const EMAIL_VALIDATOR: any = {
// 	provide: NG_VALIDATORS,
// 	useExisting: forwardRef(() => validateDuplicateMapField()),
// 	multi: true
//   };
  
@Component({
  selector: 'experiment-form-update',
  templateUrl: './experiment-form-update.component.html',
  styleUrls: ['./experiment-form-update.component.scss'],
//   providers: [EMAIL_VALIDATOR]
})
export class ExperimentFormUpdateComponent implements OnInit {
